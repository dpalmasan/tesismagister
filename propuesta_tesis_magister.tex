...
Se tomará como {\em baseline} el método descrito en \cite{t40}, el cual considera las características estadísticas que se muestran en la tabla \ref{t2} para luego aplicar una regresión. Por otro lado, se considerarán otros métodos para medir la coherencia textual, entre ellos LSA y los métodos que utilizan teoría de centrado.
...
Grading of Text''. BookSurge Publishing, 2007.
	...
	\bibitem{t47} C. Smith and A. Jönsson, ``Automatic Summarization As
Means Of Simplifying Texts, An Evaluation For Swedish'', in Proceedings of the 18th Nordic Conference of Computational Linguistics NODALIDA 2011, B. Sandford Pedersen,
G. Nespore, and I. Skadina, Eds., 2011, pp. 198?205.
